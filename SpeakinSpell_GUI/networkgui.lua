				...
				AutoSyncGroup = {
					...
					args = {
						Login = {
							...
							desc = L["Send a data sharing request to GUILD, RAID, PARTY, and INSTANCE_CHAT channels every time you login or /reloadui"],
...
--							desc = L["|cffff0000(not yet implemented)|r\nEnable automatic sync requests sent to the channel when you join a PARTY, GUILD, RAID, or INSTANCE_CHAT"],
...
--						},
						SyncNowBroadcast = {
							...
							type = "execute",
							name = L["Global Sync"],
							desc = L["Send a data sharing request to GUILD, RAID, PARTY, and INSTANCE_CHAT channels.\n\nSame as \"/ss sync\""],
							func = function()
