...
SpeakinSpell:PrintLoading("defaults/DefaultSpeeches-koKR.lua")
	...
	Content = {
		...
		["UNIT_SPELLCAST_SENTRITUAL_OF_REFRESHMENT"] = {
			["Messages"] = {
				...
				"<player's> Tasty Cake<TM> - WARNING: may cause nauseu, loss of appetite, blindness, fear, stunlock, or spontaneous transmutation into a sheep, pig, or turtle. Consult your doctor before eating <player's> Tasty Strudel<TM>", -- [4]
				"<player's> Tasty Cake<TM> - Now with 30% more Flavor Power!", -- [5]
				"<player's> Tasty Cake<TM> - Try all new Organic <player's> Tasty Strudel<TM>! Now in Teriaki Tofu Flavor!", -- [6]
				"<player's> Tasty Cake<TM> - It's Strudeltastic<TM>!!", -- [7]
				"<player's> Tasty Cake<TM> - Now with +35 Stamina Buff!! (also-gives-minus-thirty-five-stamina-debuff-no-actual-buff-may-be-visible-consult-your-doctor-before-eating <player's> Tasty Strudel<TM>)", -- [8]
				"<player's> Tasty Cake<TM> - The Official Cereal of Beauty and the Beast VII: Beauty in Azeroth (sings) Be... a... pest! Be a pest! Put my patience to the test! RENT IT TODAY!", -- [9]
