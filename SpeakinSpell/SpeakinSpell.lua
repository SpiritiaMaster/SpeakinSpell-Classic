...
function SpeakinSpell:OnLoad()
	...
	self:CreateGUIStub()		-- creates a "/ss options" button in the Blizzard interface options frame
...
--		["ACHIEVEMENT"]							= L["Achievement Earned by "], -- .. eventname = "me" or "someone nearby" or "a guild member"
		...
		["SPELL_AURA_REMOVED_BUFF"]				= L["When I lose the buff: "],--..spellname
		["SPELL_AURA_REMOVED_DEBUFF"]			= L["When I lose the debuff: "],--..spellname
		...
		["UNIT_SPELLCAST_SENT"]					= L["When I Start Casting: "],--..spellname
...
--		["PETUNIT_SPELLCAST_SENT"]				= L["When my Pet Starts Casting: "],--..spellname
...
--		["ACHIEVEMENT"]							= ACHIEVEMENTS, -- .. eventname = "me" or "someone nearby" or "a guild member"
		...
		["SPELL_AURA_REMOVED_BUFF"]				= L["Fading Buffs (includes procs)"],
		["SPELL_AURA_REMOVED_DEBUFF"]			= L["Fading Debuffs"],
...
function SpeakinSpell:CreateChannelTable()
	...
	local GlobalStrings = {
		{
			key = "SAY", --channel ID for SendChatMessage
			text = SAY, --localized name of that chat channel
			slash = SLASH_SAY1, --localized "/s"
		},
		{
			key = "YELL",
			text = YELL,
