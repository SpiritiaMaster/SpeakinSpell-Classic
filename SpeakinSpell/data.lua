...
function SpeakinSpell:InitDefaultSavedData()
	...
	local DEFAULT_EVENTHOOKS = SpeakinSpell:LoadDefaultEventHooks()
...
--[[function SpeakinSpell:LoadActiveCompanions()
...
function SpeakinSpell:MatchesFilter(DetectedEvent)
...
function SpeakinSpell:EraseAllSpeeches()
